...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.label_2.setMaximumSize(QtCore.QSize(500, 900))
        font = QtGui.QFont()
        ...
        self.pushButton.clicked.connect(MainWindow.getFromCamera)
        self.pushButton_2.clicked.connect(MainWindow.getCurrentPic)
        QtCore.QMetaObject.connectSlotsByName(MainWindow)

    def retranslateUi(self, MainWindow):
        _translate = QtCore.QCoreApplication.translate
        MainWindow.setWindowTitle(_translate("MainWindow", "视频检测模式"))
        self.pushButton.setWhatsThis(_translate("MainWindow", "<html><head/><body><p>选择一幅图像进行检测</p></body></html>"))
        self.pushButton.setText(_translate("MainWindow", "从摄像头选择"))
        self.pushButton_2.setText(_translate("MainWindow", "截取当前画面"))
        self.pushButton_3.setWhatsThis(_translate("MainWindow", "<html><head/><body><p>回到主界面</p></body></html>"))
